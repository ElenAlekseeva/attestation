document.querySelector("#password1").oninput = function() {
...
document.querySelector("#password2").oninput = function() {
...
document.querySelector(".form__auth-btn").click = function () {
  const userPassFirst = document.querySelector("#password1").value;
  const userPassSecond = document.querySelector("#password2").value;
